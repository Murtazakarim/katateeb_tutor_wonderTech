        ...
        children: [
          CustomPaint(
            ...
            child: (widget.center != null)
              ...
              children: [
                RotatedBox(quarterTurns: widget.horizontal ?-4 : -1,
                    child: Center(child: Padding(
                      padding: EdgeInsets.only(left:widget.horizontal ? 8:0,bottom:widget.horizontal ? 0:8),
                      child: widget.center!,
                    ))),
              ],
            )
...
class _LinearPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    backgroundPath.addRRect(RRect.fromRectAndRadius(
        Rect.fromLTWH(0, 0, size.width, size.height), const Radius.circular(5)));
